            ...
            <router-link :to="`/course/${pop.id}`" >
                ...
                <div class="course-info">
                    <div class="col-time">
                        <div class="video-info">
                            <span class="col-video">{{pop.lessons_count}}</span>
                            <span class="video">Видеоуроков(а)</span>
                        </div>
                        <div class="time-info">
                            <!-- <span class="sum-time">Время курса </span> -->
                            <span class="time">{{pop.course_duration}}</span>
                        </div>
                    </div>
                    <!-- <div class="raiting">
                ...
                <div class="course-info">
                    <div class="author">
                        ...
                        @click.native="authorClicked(pop)"
                         class="author-name">{{pop.username}}</router-link>
                    </div>
